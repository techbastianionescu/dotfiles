...
echo "[bootstrap] Targets: $CLAUDE_HOME, $HOME"
echo
...
# Starship binary isn't shipped with this repo. Prompt uses Starship's defaults
# (no starship.toml) — install the binary from https://starship.rs to activate.
